var JSONFormatter = function(options) {
  ...
  var self = {
    ...
    handleBeforeFeatureEvent: function handleBeforeFeatureEvent(event, callback) {
      ...
      mark_current_scenario_as_skipped: function mark_current_scenario_as_skipped() {
          currentScenario["result"] = {"status" : "skipped"}
      },
